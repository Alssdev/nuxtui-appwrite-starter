<template>
  <div class="p-6 max-w-3xl mx-auto bg-white rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-2xl font-bold text-gray-800">Registrar Tiempos - Seguidor de líneas</h1>
...
const response = await $databases.listDocuments(
  '686c5e84001c62957f30',
  '686c5fd50012c057e441',
  [
    Query.or([
      Query.equal('Categoria_1', 'Seguidor'),
